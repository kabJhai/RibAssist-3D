...
Expected result: frozen `recall@10 0.0%` (0/601); **L2 `recall@10 2.50%` (15/601) at 0.436 false-3D/case,
case-bootstrap 95% CI [0.69%, 4.48%]**. This value is the end-to-end commitment yield (all-fracture denominator),
reported under the JSON key `recall@10`. Results: `outputs/sealed/{frozen,L2}_sealed_D1.json`.
